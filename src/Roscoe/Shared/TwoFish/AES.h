...
#include	<stdio.h>
#include	"Shared/TwoFish/TwoFishPlatform.h"			/* platform-specific defines */
...
#ifdef _WIN32
#define	BIOSmakeKey			makeKey
#define	BIOScipherInit		cipherInit
#define	BIOSblockEncrypt	blockEncrypt
#define	BIOSblockDecrypt	blockDecrypt
#define	BIOSreKey			reKey
#endif
