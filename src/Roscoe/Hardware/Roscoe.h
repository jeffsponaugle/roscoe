...
#define	ROSCOE_SYSTEM_SRAM_SIZE				(ROSCOE_SYSTEM_SRAM_SIZE_TOTAL - ROSCOE_STICKY_RAM_SIZE)
#define	ROSCOE_SYSTEM_SRAM_SIZE_TOTAL		(2*1024*1024)

// Sticky RAM - taken from SRAM - not touched during startup
#define	ROSCOE_STICKY_RAM_SIZE				1024
#define	ROSCOE_STICKY_RAM_BASE				((ROSCOE_FAST_SRAM_SIZE + ROSCOE_FAST_SRAM_BASE) - ROSCOE_STICKY_RAM_SIZE)

// Data within the stickyram area
#define	STICKYRAM_OFFSET_FAULT_REGS			0
#define	STICKRAM_SIZE_FAULT_REGS			(16*4)						// 16 32 bit registers
...
#define	POST_7SEG_DP						0x7f
#define	POST_7SEG_A							0xfe
#define	POST_7SEG_B							0xfd
#define	POST_7SEG_C							0xfb
#define	POST_7SEG_D							0xf7
#define	POST_7SEG_E							0xef
#define	POST_7SEG_F							0xdf
#define	POST_7SEG_G							0xbf
...
#define	POSTCODE_BOOTLOADER_RTC_INIT_START		((POST_7SEG_HEX_0 << 8) + POST_7SEG_HEX_D)	// 0d - Monitor RTC init start
#define	POSTCODE_BOOTLOADER_RTC_SPEED_TEST		((POST_7SEG_HEX_0 << 8) + POST_7SEG_HEX_E)	// 0e - Monitor CPU speed test start
#define	POSTCODE_BOOTLOADER_PTC_INIT			((POST_7SEG_HEX_0 << 8) + POST_7SEG_HEX_F)	// 0f - Monitor PTC init start
#define	POSTCODE_BOOTLOADER_CONSOLE_START		((POST_7SEG_HEX_1 << 8) + POST_7SEG_HEX_0)	// 10 - Monitor console begin
